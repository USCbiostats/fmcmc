...
# Generating kernel with NA for unbounded parameters
# First three parameters unbounded, fourth parameter must be positive
kern <- kernel_ram(warmup = 1000, lb = c(NA, NA, NA, .001))
