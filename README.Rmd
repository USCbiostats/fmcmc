...
Markov Chain Monte Carlo methods based on the Metropolis-Hasing algorithm. This
...
3.  **User defined transition kernels**: Besides of canonical Gaussian Kernel,
    ...
    example: `kernel_normal`, `kernel_unif`, or `kernel_reflective`.
...
`kernel_reflective` (which implements a normal kernel with boundaries) function:
