...
[![Build status](https://ci.appveyor.com/api/projects/status/lirawn11ssw9cq07?svg=true)](https://ci.appveyor.com/project/gvegayon/fmcmc)
...
3.  **User defined transition kernels**: Besides of canonical Gaussian Kernel,
    ...
    example: `kernel_normal`, `kernel_normal_reflective`, `kernel_unif`, or
...
use multiple chains and the Gelman diagnostic to check for convergence of the
chain:
